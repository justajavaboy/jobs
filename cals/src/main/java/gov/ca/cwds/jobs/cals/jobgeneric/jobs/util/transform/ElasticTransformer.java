package gov.ca.cwds.jobs.cals.jobgeneric.jobs.util.transform;
...
import gov.ca.cwds.jobs.cals.jobgeneric.dao.ApiClientCountyAware;
import gov.ca.cwds.jobs.cals.jobgeneric.dao.ApiLegacyAware;
import gov.ca.cwds.jobs.cals.jobgeneric.dao.ApiMultiplePersonAware;
import gov.ca.cwds.jobs.cals.jobgeneric.dao.ApiScreeningAware;
import gov.ca.cwds.jobs.cals.jobgeneric.data.persistence.cms.rep.CmsReplicatedEntity;
...
public class ElasticTransformer {
  ...
  public static <T extends PersistentObject> UpdateRequest prepareUpsertRequest(
    ...
    final Pair<String, String> json =
        ElasticTransformer
            .prepareUpsertJson(docPrep, esp, t, docPrep.getOptionalElementName(),
