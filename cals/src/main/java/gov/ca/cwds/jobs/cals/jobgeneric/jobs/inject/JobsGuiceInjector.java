...
import gov.ca.cwds.jobs.cals.jobgeneric.dao.cms.BatchBucket;
import gov.ca.cwds.jobs.cals.jobgeneric.dao.cms.ReplicatedAttorneyDao;
import gov.ca.cwds.jobs.cals.jobgeneric.dao.cms.ReplicatedClientDao;
import gov.ca.cwds.jobs.cals.jobgeneric.dao.cms.ReplicatedCollateralIndividualDao;
import gov.ca.cwds.jobs.cals.jobgeneric.dao.cms.ReplicatedEducationProviderContactDao;
import gov.ca.cwds.jobs.cals.jobgeneric.dao.cms.ReplicatedOtherAdultInPlacemtHomeDao;
import gov.ca.cwds.jobs.cals.jobgeneric.dao.cms.ReplicatedOtherChildInPlacemtHomeDao;
import gov.ca.cwds.jobs.cals.jobgeneric.dao.cms.ReplicatedOtherClientNameDao;
import gov.ca.cwds.jobs.cals.jobgeneric.dao.cms.ReplicatedPersonCasesDao;
import gov.ca.cwds.jobs.cals.jobgeneric.dao.cms.ReplicatedPersonReferralsDao;
import gov.ca.cwds.jobs.cals.jobgeneric.dao.cms.ReplicatedRelationshipsDao;
import gov.ca.cwds.jobs.cals.jobgeneric.dao.cms.ReplicatedReporterDao;
import gov.ca.cwds.jobs.cals.jobgeneric.dao.cms.ReplicatedSafetyAlertsDao;
import gov.ca.cwds.jobs.cals.jobgeneric.dao.cms.ReplicatedServiceProviderDao;
import gov.ca.cwds.jobs.cals.jobgeneric.dao.cms.ReplicatedSubstituteCareProviderDao;
import gov.ca.cwds.jobs.cals.jobgeneric.dao.ns.EsIntakeScreeningDao;
import gov.ca.cwds.jobs.cals.jobgeneric.data.persistence.cms.EsChildPersonCase;
import gov.ca.cwds.jobs.cals.jobgeneric.data.persistence.cms.EsClientAddress;
import gov.ca.cwds.jobs.cals.jobgeneric.data.persistence.cms.EsParentPersonCase;
import gov.ca.cwds.jobs.cals.jobgeneric.data.persistence.cms.EsPersonReferral;
import gov.ca.cwds.jobs.cals.jobgeneric.data.persistence.cms.EsRelationship;
import gov.ca.cwds.jobs.cals.jobgeneric.data.persistence.cms.EsSafetyAlert;
import gov.ca.cwds.jobs.cals.jobgeneric.data.persistence.cms.rep.ReplicatedAddress;
import gov.ca.cwds.jobs.cals.jobgeneric.data.persistence.cms.rep.ReplicatedAttorney;
import gov.ca.cwds.jobs.cals.jobgeneric.data.persistence.cms.rep.ReplicatedClient;
import gov.ca.cwds.jobs.cals.jobgeneric.data.persistence.cms.rep.ReplicatedClientAddress;
import gov.ca.cwds.jobs.cals.jobgeneric.data.persistence.cms.rep.ReplicatedCollateralIndividual;
import gov.ca.cwds.jobs.cals.jobgeneric.data.persistence.cms.rep.ReplicatedEducationProviderContact;
import gov.ca.cwds.jobs.cals.jobgeneric.data.persistence.cms.rep.ReplicatedOtherAdultInPlacemtHome;
import gov.ca.cwds.jobs.cals.jobgeneric.data.persistence.cms.rep.ReplicatedOtherChildInPlacemtHome;
import gov.ca.cwds.jobs.cals.jobgeneric.data.persistence.cms.rep.ReplicatedOtherClientName;
import gov.ca.cwds.jobs.cals.jobgeneric.data.persistence.cms.rep.ReplicatedReporter;
...
import gov.ca.cwds.jobs.cals.jobgeneric.data.persistence.ns.EsIntakeScreening;
import gov.ca.cwds.jobs.cals.jobgeneric.data.persistence.ns.IntakeScreening;
import gov.ca.cwds.jobs.cals.jobgeneric.jobs.BasePersonIndexerJob;
import gov.ca.cwds.jobs.cals.jobgeneric.jobs.config.JobOptions;
import gov.ca.cwds.jobs.cals.jobgeneric.jobs.exception.JobsException;
import gov.ca.cwds.jobs.cals.jobgeneric.jobs.util.JobLogs;
import gov.ca.cwds.jobs.cals.jobgeneric.jobs.util.elastic.XPackUtils;
import gov.ca.cwds.jobs.cals.jobgeneric.jobs.util.transform.ElasticTransformer;
