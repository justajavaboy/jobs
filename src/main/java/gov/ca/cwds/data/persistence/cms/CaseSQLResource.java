...
public class CaseSQLResource implements ApiMarker {
  ...
  public static final String SELECT_CLIENT_CASE_RELATIONSHIP = 
     ...
     //   + " 1                    AS STANZA, \n"
          + " 0                    AS RELATION \n"
          + "FROM (SELECT DISTINCT rc1.FKREFERL_T AS CASE_ID FROM GT_REFR_CLT rc1) DRV1 \n"
    ...
    //    + " 2                    AS STANZA, \n"
          ...
          + "FROM (SELECT DISTINCT rc2.FKCLIENT_T FROM GT_REFR_CLT rc2) DRV2 \n"
          + "JOIN CLN_RELT REL2 ON REL2.FKCLIENT_T = DRV2.FKCLIENT_T \n"
          + "JOIN CASE_T   CAS2 ON CAS2.FKCHLD_CLT = REL2.FKCLIENT_0 \n"
    ...
    //    + " 3                    AS STANZA, \n"
          ...
          + "FROM (SELECT DISTINCT rc3.FKCLIENT_T FROM GT_REFR_CLT rc3) DRV3, CLN_RELT REL3, CASE_T CAS3 \n"
          + "WHERE CAS3.FKCHLD_CLT = REL3.FKCLIENT_T \n"
          + "AND REL3.FKCLIENT_0 = DRV3.FKCLIENT_T \n"
