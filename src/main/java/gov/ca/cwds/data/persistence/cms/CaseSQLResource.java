...
public class CaseSQLResource implements ApiMarker {
  ...
  public static final String SELECT_FOCUS_CHILD_PARENTS = 
       "SELECT DISTINCT cas.FKCHLD_CLT AS FOCUS_CHILD_ID,  \n"
          + "ccc.IDENTIFIER AS L_CLIENT_ID, TRIM(ccc.COM_FST_NM) AS L_FIRST, TRIM(ccc.COM_MID_NM) AS L_MIDDLE, TRIM(ccc.COM_LST_NM) AS L_LAST, ccc.BIRTH_DT AS L_BIRTH, ccc.GENDER_CD AS L_GENDER, \n"
          + "TRIM(sc.SHORT_DSC) AS REL_TYPE, sc.SYS_ID AS REL_CODE,  \n"
          + "cc0.IDENTIFIER AS R_CLIENT_ID, TRIM(cc0.COM_FST_NM) AS R_FIRST, TRIM(cc0.COM_MID_NM) AS R_MIDDLE, TRIM(cc0.COM_LST_NM) AS R_LAST, cc0.BIRTH_DT AS R_BIRTH, cc0.GENDER_CD AS R_GENDER \n"
     ...
     + "UNION \n"
     + "SELECT DISTINCT cas.FKCHLD_CLT AS FOCUS_CHILD_ID,  \n"
          + "cc0.IDENTIFIER AS L_CLIENT_ID, TRIM(cc0.COM_FST_NM) AS L_FIRST, TRIM(cc0.COM_MID_NM) AS L_MIDDLE, TRIM(cc0.COM_LST_NM) AS L_LAST, cc0.BIRTH_DT AS L_BIRTH, cc0.GENDER_CD AS L_GENDER, \n"
          + "sc2.SHORT_DSC AS REL_TYPE, sc2.SYS_ID AS REL_CODE,  \n"
          + "ccc.IDENTIFIER AS R_CLIENT_ID, TRIM(ccc.COM_FST_NM) AS R_FIRST, TRIM(ccc.COM_MID_NM) AS R_MIDDLE, TRIM(ccc.COM_LST_NM) AS R_LAST, ccc.BIRTH_DT AS R_BIRTH, ccc.GENDER_CD AS R_GENDER \n"
          + "FROM (SELECT DISTINCT gt.FKREFERL_T AS CASE_ID FROM GT_REFR_CLT gt) x \n"
          + "JOIN CASE_T cas   ON cas.IDENTIFIER  = x.CASE_ID \n"
