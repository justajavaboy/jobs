...
public class CaseSQLResource implements ApiMarker {
  ...
  public static final String INSERT_CLIENT_CASE =
      ...
      + "SELECT DISTINCT x.THIS_CLIENT_ID, x.CASE_ID, 'X' AS SENSTV_IND \nFROM ( \n"
          + " SELECT CAS1.IDENTIFIER    AS CASE_ID,  \n"
          + "        CAS1.FKCHLD_CLT    AS THIS_CLIENT_ID,  \n"
          + "        CAS1.FKCHLD_CLT    AS FOCUS_CHILD_ID \n" 
          + " FROM CASE_T CAS1 \n"
          + " WHERE CAS1.FKCHLD_CLT IN (SELECT gt1.IDENTIFIER FROM CWSRSQ.GT_ID gt1) \n"
          + " UNION ALL \n" 
          ...
          + "   AND REL2.FKCLIENT_T IN (SELECT gt2.IDENTIFIER FROM CWSRSQ.GT_ID gt2) \n"
          + " UNION \n" 
          ...
          + "   AND REL3.FKCLIENT_0 IN (SELECT gt3.IDENTIFIER FROM CWSRSQ.GT_ID gt3) \n" 
      + ") x ";
  //@formatter:on
