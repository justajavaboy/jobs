...
@NamedNativeQuery(name = "gov.ca.cwds.data.persistence.cms.EsRelationship.findAllUpdatedAfter",
    ...
    + "UNION ALL \n"
      + "SELECT \n"
        ...
        + " d2.RELATED_LEGACY_ID, \n"
        + " d2.RELATED_SENSITIVITY_IND, \n"
        + " d2.RELATED_LEGACY_LAST_UPDATED, \n"
        + " d2.RELATED_LEGACY_LAST_UPDATED_ID, \n"
        + " d2.RELATED_FIRST_NAME, \n"
        + " d2.RELATED_LAST_NAME, \n"
        + " d2.REL_CODE, \n"
        + " d2.THIS_LEGACY_ID, \n"
        + " d2.THIS_SENSITIVITY_IND, \n"
        + " d2.THIS_LEGACY_LAST_UPDATED, \n"
        + " d2.THIS_LEGACY_LAST_UPDATED_ID, \n"
        + " d2.THIS_FIRST_NAME, \n"
        + " d2.THIS_LAST_NAME, \n"
        ...
        + " d2.LAST_CHG \n"
        + "FROM DRIVER d2 \n"
        + "WHERE 1=1 OR d2.REL_IBMSNAP_LOGMARKER > :after\n"
        + "ORDER BY 2, 9 \n"
...
@NamedNativeQuery(
   ...
   + "UNION ALL\n"
     + "SELECT \n"
       + " 1 AS REVERSE_RELATIONSHIP         AS REVERSE_RELATIONSHIP, \n"
       ...
       + " d2.REL_IBMSNAP_LOGMARKER          AS REL_IBMSNAP_LOGMARKER, \n"
       + " d2.REL_IBMSNAP_OPERATION          AS REL_IBMSNAP_OPERATION, \n"
       + " d2.THIS_IBMSNAP_LOGMARKER         AS THIS_IBMSNAP_LOGMARKER, \n"
       + " d2.THIS_IBMSNAP_OPERATION         AS THIS_IBMSNAP_OPERATION, \n"
       + " d2.RELATED_IBMSNAP_LOGMARKER      AS RELATED_IBMSNAP_LOGMARKER, \n"
       + " d2.RELATED_IBMSNAP_OPERATION      AS RELATED_IBMSNAP_OPERATION, \n"
       + " d2.LAST_CHG AS LAST_CHG\n"
       + "FROM DRIVER d2 \n"
